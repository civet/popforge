package
{
	...
	[SWF( backgroundColor='0x111111', frameRate='30', width='320', height='272')]
	...
	public class FlangerSandbox extends Sprite
	{
		...
		public function FlangerSandbox()
		{
			...
			debugField.defaultTextFormat = new TextFormat( 'verdana', 9, 0x999999, true );
			debugField.text = '...';
			addChild( debugField );
		...
		{
			var p: String = new String( '0' ).concat( ( event.bytesLoaded / event.bytesTotal * 100 ).toString() ).substr( -2 );
			
			debugField.text = p + '% loaded';
		}
		...
		private function onLoaderComplete( event: Event ): void
		{
			...
			debugField.text = 'Flanger Audio Processor'
